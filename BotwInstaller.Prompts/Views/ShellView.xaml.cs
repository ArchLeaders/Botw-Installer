...
namespace BotwInstaller.Prompts.Views
{
    /// <summary>
    ...
    public partial class ShellView : Window
    {
        ...
        public ShellView()
        {
            ...
            if (File.Exists($"{Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)}\\BotwInstaller.Prompts\\settings.ini"))
                if (File.ReadAllLines($"{Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)}\\BotwInstaller.Prompts\\settings.ini")[0].ToLower() == "light")
                {
