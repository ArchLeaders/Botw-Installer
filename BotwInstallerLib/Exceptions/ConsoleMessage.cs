...
namespace BotwInstallerLib.Exceptions
{
    ...
    {
        public static void Print(string? msg, ConsoleColor color = ConsoleColor.Gray, bool hideFromConsole = false)
        {
            if (hideFromConsole)
            {
        ...
        public static void Error(string method, string[]? args, string error = "- No error details", string? partialReturn = null)
        {
            string? strArgs = null;
