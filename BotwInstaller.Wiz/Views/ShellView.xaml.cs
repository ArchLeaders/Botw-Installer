...
namespace BotwInstaller.Wiz.Views
{
    /// <summary>
    ...
    public partial class ShellView : Window
    {
        ...
        public ShellView()
        {
            ...
            if (File.Exists($"{Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)}\\BotwInstaller.Wiz\\settings.ini"))
                if (File.ReadAllLines($"{Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)}\\BotwInstaller.Wiz\\settings.ini")[0].ToLower() == "light")
                {
